...
public class PanRepElimCta extends Fragment implements View.OnClickListener {
    private Mensaje mje;
    private Context ctx;
    ...
    public PanRepElimCta(Map<String, String> datosActuales){
    ...
    public void onClick(View view){
        if(view.getId()==R.id.btnEliminar){
            JSON json = new JSON();
            json.agregarDato("tipoPersona", "rep"); //Clave de usuario
