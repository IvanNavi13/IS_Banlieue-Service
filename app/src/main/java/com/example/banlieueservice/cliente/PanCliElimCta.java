...
public class PanCliElimCta extends Fragment implements View.OnClickListener {
    private Mensaje mje;
    private Context ctx;
    ...
    public PanCliElimCta(Map<String, String> datosActuales){
    ...
    public void onClick(View view){
        if(view.getId()==R.id.btnEliminar){
            JSON json = new JSON();
            json.agregarDato("tipoPersona", "cli"); //Clave de usuario
